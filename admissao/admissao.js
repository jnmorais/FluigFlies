$(document).ready(function () {
    ...
    if (ATV == 0 || ATV == 1 || ATV == 4 || ATV == null || ATV == 9 || ATV == 37 || ATV == 98) {
        ...
        show_on_click('rd_acsRd', 'Não, será necessário alugar um computador.', null, 'pastasRede')
        show_on_click('rd_eqpRossi', 'Não, será necessário alugar um computador.', null, 'entrg_RossiEqp')
    ...
    if (ATV >= 4 || ATV == null) {
        ...
        hide_on_load('rd_acsRd', 'Não, será necessário alugar um computador.', null, 'pastasRede')
        hide_on_load('rd_eqpRossi', 'Não, será necessário alugar um computador.', null, 'entrg_RossiEqp')
