$(document).ready(function () {
  ...
  if (ATV) {
    ...
    show_on_click("rd_obras", "Sim", null, "infomPremio")
    ...
    if (
      $("input[name$='rd_mtvDslg']:checked").val() == rd_mtvDslg1 ||
    ...
    if (
      $("input[name$='rd_mtvDslg']:checked").val() ==
...
function setSelectedZoomItem(selectedItem) {
  if (
    selectedItem.inputId == "txt_cargo" ||
    selectedItem.inputId == "txt_setor"
  ) {
